...
<div class="app-container">
    ...
    <el-table :stripe="true" :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column label="操作" width="270" align="center">
            <template slot-scope="scope">
                <el-button size="mini" v-permission="['account-list-offline']" v-if="accountStatus[scope.row.status].msg=='正常'&&scope.row.accountType==3" type="danger" @click="freeze(scope.row,1)">冻结</el-button>
